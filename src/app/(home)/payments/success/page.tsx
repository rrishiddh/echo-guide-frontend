        ...
        <div className="container px-4 max-w-4xl mx-auto space-y-8">
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              <div className="border-b pb-6">
                ...
                <div className="space-y-2 text-sm text-gray-600">
                  <div className="flex items-center gap-2">
                    ...
                    <span>{formatDate(booking.bookingDate, "MMMM dd, yyyy")}</span>
                  </div>
                  <div className="flex items-center gap-2">
              ...
              <div className="border-b pb-6">
                ...
                <p className="text-gray-700 font-medium">{booking.guide?.name}</p>
                <p className="text-sm text-gray-600">{booking.guide?.email}</p>
              </div>
            ...
            <CardContent>
              <ol className="space-y-3 text-gray-700">
                <li className="flex gap-3">
                  ...
                  <span>Check your email for confirmation and guide contact details</span>
                </li>
                <li className="flex gap-3">
                  <span className="flex-shrink-0 w-6 h-6 bg-blue-100 text-blue-600 rounded-full flex items-center justify-center text-sm font-medium">
                    2
                  </span>
                  <span>Review the tour itinerary and prepare any required items</span>
                </li>
                <li className="flex gap-3">
                  <span className="flex-shrink-0 w-6 h-6 bg-blue-100 text-blue-600 rounded-full flex items-center justify-center text-sm font-medium">
                    3
                  ...
                  <span>
                    Arrive at the meeting point on time (check your booking for location)
                  </span>
                </li>
                <li className="flex gap-3">
                  <span className="flex-shrink-0 w-6 h-6 bg-blue-100 text-blue-600 rounded-full flex items-center justify-center text-sm font-medium">
                  ...
                  <span>Enjoy the tour and leave a review afterward</span>
                </li>
              </ol>
            </CardContent>
          </Card>

          {/* Use existing PaymentHistory component */}
          <PaymentHistory />

          <div className="flex flex-col sm:flex-row gap-4">
            <Button className="flex-1" onClick={() => router.push("/dashboard/tourist/bookings")}>
              View My Bookings
            </Button>
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
            <p className="text-sm text-blue-800">
              Need help? Contact the guide directly or visit our support center for assistance.
            </p>
          </div>
        </div>
      </div>
